...
try:
    ...
    _import_structure["scheduling_runge_kutta"] = ["RungeKuttaScheduler"]
    _import_structure["scheduling_parallel_runge_kutta"] = ["ParallelRungeKuttaScheduler"]
    _import_structure["scheduling_dpm_runge_kutta"] = ["DPMRungeKuttaScheduler"]
    _import_structure["scheduling_exp_runge_kutta"] = ["ExpRungeKuttaScheduler"]
    _import_structure["scheduling_adaptive_runge_kutta"] = ["AdaptiveHeunScheduler"]
    _import_structure["scheduling_dpm_adaptive_runge_kutta"] = ["DPMAdaptiveRungeKutta"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .scheduling_runge_kutta import RungeKuttaScheduler
        from .scheduling_exp_runge_kutta import ExpRungeKuttaScheduler
        from .scheduling_dpm_runge_kutta import DPMRungeKuttaScheduler
        from .scheduling_adaptive_runge_kutta import AdaptiveHeunScheduler
        from .scheduling_dpm_adaptive_runge_kutta import DPMAdaptiveHeunScheduler
        from .scheduling_parallel_runge_kutta import ParallelRungeKuttaScheduler
